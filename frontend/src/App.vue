  ...
  <SidebarProvider>
    <div class="flex h-screen overflow-hidden bg-background">
      ...
      <SidebarTrigger asChild>
        <button
          class="fixed top-6 left-[calc(var(--sidebar-width)+4px)] z-50 rounded-full border border-sidebar-border bg-sidebar p-1
                 text-sidebar-foreground shadow-sm transition-all duration-200 hover:bg-sidebar-border"
        >
